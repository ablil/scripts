...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser("ssh bruteforcer in python ( This script is very slow, use threading to save time )")
	parser.add_argument('target', nargs=1, metavar='hostname', type=str)
	parser.add_argument('port', nargs=1, type=int)
	parser.add_argument('username', nargs=1, type=str)
	parser.add_argument('wordlist', nargs=1, type=str, help='line sperated passwords in wordlist.txt')
